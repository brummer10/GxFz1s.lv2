...
static void ref_value_changed(GtkAdjustment *adj, gpointer* args) {
    ...
    gx_maestro_fz1sUI* ui = (gx_maestro_fz1sUI*)arg->ui;
    if (ui->block) {
        ui->block = 0;
        return;
    }
...
static LV2UI_Handle instantiate(const LV2UI_Descriptor*   descriptor,
    ...
    *widget = NULL;
    ...
    set_expose_func(GX_FZ1S_PAINT_BOX(ui->pbox),"pedal_expose");
    ...
    set_expose_func(GX_FZ1S_PAINT_BOX(ui->pf1box),"frame_expose");
    ...
    ui->label[2] = gtk_label_new("SUSTAIN");
    ...
    ui->args[2]->ui = ui;
    ui->args[2]->port_index = (int)SUSTAIN;
    ...
    ui->label[1] = gtk_label_new("FILTER");
    ...
    ui->args[1]->ui = ui;
    ui->args[1]->port_index = (int)FILTER;
